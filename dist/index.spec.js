...
describe('JsonAdapter - lookupValue', () => {
    ...
    beforeEach(() => {
        const schema = {};
        adapter = new index_1.default(schema, {}, {}, {
            sampleDict: [
                ['key1', 'value1'],
                ['key2', 'value2'],
                ['*', 'defaultValue'],
    ...
    it('should throw an error if the dictionary is not found', () => {
        expect(() => adapter.lookupValue('invalidDict', 'key1')).toThrow('Invalid dictionary! invalidDict not found or it is not an array');
    });
    ...
    it('should return the mapped value for a "contains" wildcard match', () => {
        ...
        const result = adapter.lookupValue('wildcardDict', 'inTheMiddleOfSomething');
        expect(result).toBe('matchedValue');
    });
    ...
    it('should handle empty dictionaries gracefully', () => {
        const schema = {};
        adapter = new index_1.default(schema, {}, {}, { emptyDict: [] });
...
describe('baseline tests', () => {
    ...
    it('should map fields based on schema', () => {
        ...
        const adapter = new index_1.default(schema);
    ...
    it('should replace values using $var operator', () => {
        ...
        const adapter = new index_1.default(schema, {}, {}, {}, vars);
        const result = adapter.mapTransform({});
    ...
    it('should apply transformations with $transform operator', () => {
        ...
        const adapter = new index_1.default(schema, transformers);
    ...
    it('should use $lookup to replace values from dictionary', () => {
        ...
        const adapter = new index_1.default(schema, {}, {}, dictionaries);
    ...
    it('should include keys conditionally with $filter operator', () => {
        ...
        const filters = { isPhoneAvailable: (value) => !!value };
        const adapter = new index_1.default(schema, {}, filters);
    ...
    it('should throw error for unsupported source types', () => {
        const schema = {};
        const adapter = new index_1.default(schema);
        expect(() => adapter.mapTransform(null)).toThrow('Unsupported source type! Only object and array are supported at top-level');
    });
});
...
describe('JsonAdapter - mapTransform error cases', () => {
    ...
    it('should throw an error if object schema is invalid (neither object nor array)', () => {
        ...
        expect(() => new index_1.default(invalidSchema, mockTransformers, mockFilters, mockDictionaries, mockVars)).toThrow(/Invalid schema! Expected object or array schema/);
    });
    it('should throw an error if array schema is invalid (neither object nor array)', () => {
        const invalidSchema = [{ key: 'value' }, 'invalid-schema'];
        expect(() => new index_1.default(invalidSchema, mockTransformers, mockFilters, mockDictionaries, mockVars)).toThrow(/Invalid schema! Expected object schema/);
    });
    it('should throw an error when schema contains unsafe properties (e.g. prototype keys)', () => {
        const unsafeSchema = {
            constructor: () => 'malicious code',
        };
        expect(() => new index_1.default(unsafeSchema, mockTransformers, mockFilters, mockDictionaries, mockVars)).toThrow(/Invalid schema! constructor is a reserved property name/);
    });
});
